...
test('it case 1 - text_cases.txt ', () => {
  ...
  expect(radar(input)).toStrictEqual([{ x: 0, y: 40 }])
})

test('it case 2 - text_cases.txt ', () => {
  let input = {
  ...
  expect(radar(input)).toStrictEqual([{ x: 0, y: 80 }])
})

test('it case 3 - text_cases.txt ', () => {
  let input = {
  ...
  expect(radar(input)).toStrictEqual([{ x: 10, y: 30 }])
})

test('it case 4 - text_cases.txt ', () => {
  let input = {
  ...
  expect(radar(input)).toStrictEqual([{ x: 5, y: 35 }])
})

test('it case 5 - text_cases.txt ', () => {
  let input = {
...
test('it case 6 - text_cases.txt ', () => {
  ...
  expect(radar(input)).toStrictEqual([{ x: 35, y: 5 }])
})

test('it case 7 - text_cases.txt ', () => {
  let input = {
    protocols: ['furthest-enemies'],
    scan: [
      {
...
test('it case 8 - text_cases.txt ', () => {
  ...
  expect(radar(input)).toStrictEqual([{ x: 0, y: 10 }])
})

test('it case 9 - text_cases.txt ', () => {
  let input = {
    protocols: ['closest-enemies'],
    scan: [
  ...
  expect(radar(input)).toStrictEqual([{ x: 3, y: 10 }])
})

test('it case 10 - text_cases.txt ', () => {
  let input = {
    protocols: ['furthest-enemies'],
    scan: [
      { coordinates: { x: 89, y: 13 }, enemies: { type: 'mech', number: 1 } },
  ...
  expect(radar(input)).toStrictEqual([{ x: 30, y: 95 }])
})

test('it case 11 - text_cases.txt ', () => {
  let input = {
  ...
  expect(radar(input)).toStrictEqual([{ x: 91, y: 30 }])
})

test('it case 12 - text_cases.txt ', () => {
  let input = {
    ...
    scan: [
      ...
      {
        enemies: { number: 15, type: 'soldier' },
        allies: 5,
        coordinates: { y: 51, x: 80 },
      },
      {
        enemies: { type: 'soldier', number: 60 },
        allies: 5,
        coordinates: { y: 91, x: 70 },
      },
      {
        enemies: { type: 'soldier', number: 40 },
        coordinates: { y: 11, x: 30 },
      },
      ...
      {
        coordinates: { y: 30, x: 91 },
        allies: 10,
        enemies: { type: 'soldier', number: 60 },
      },
      {
        coordinates: { y: 30, x: 11 },
        enemies: { number: 40, type: 'soldier' },
      },
      {
        enemies: { type: 'soldier', number: 20 },
      ...
      {
        enemies: { number: 30, type: 'mech' },
        allies: 3,
        coordinates: { y: 53, x: 81 },
      },
      {
        coordinates: { y: 70, x: 15 },
        allies: 4,
        enemies: { type: 'soldier', number: 30 },
      },
      {
        enemies: { type: 'soldier', number: 15 },
        allies: 4,
        coordinates: { y: 83, x: 19 },
      },
      {
        enemies: { number: 60, type: 'soldier' },
        coordinates: { y: 46, x: 11 },
      },
      {
        coordinates: { y: 26, x: 59 },
        allies: 6,
        enemies: { type: 'soldier', number: 40 },
      },
      {
  ...
  expect(radar(input)).toStrictEqual([{ x: 0, y: 11 }])
})

test('it case 13 - text_cases.txt ', () => {
  let input = {
  ...
  expect(radar(input)).toStrictEqual([{ x: 11, y: 58 }])
})
